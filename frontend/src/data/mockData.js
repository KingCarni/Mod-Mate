...
export const templates = [
  ...
  {
    id: "idle-economy",
    title: "Tune an idle game economy",
    category: "Game Design",
    description: "Read your gameplay loops and suggest balance tweaks with reasoning.",
    bg: "primary",
    tag: "Concept",
  },
  {
  ...
  {
    id: "notes-to-workflows",
    title: "Turn notes into structured workflows",
    category: "Business Workflow",
    description: "Convert messy notes into runnable checklists, briefs, and action items.",
    bg: "sage",
    tag: "New",
  },
  {
  ...
  {
    id: "team-companion",
    title: "Build a companion for your team",
    category: "Business Workflow",
    description: "A shared companion that learns your team's vocabulary and rituals.",
    bg: "primary",
    tag: "Concept",
  },
];
...
export const integrations = [
  {
    id: "master-draft",
    name: "Master Draft",
    description: "Embed companions inside the screenplay editor with scene-aware context.",
    status: "Internal",
  },
  {
    id: "qatalyst",
    name: "QAtalyst",
    description: "Triage bug streams and surface explanations next to repro steps.",
    status: "Coming Soon",
  },
  {
    id: "campaign-brain",
    name: "Campaign Brain",
    description: "Plug GM-Mate directly into your tabletop campaign workspace.",
    status: "Planned",
  },
  {
    id: "idle-game-creator",
    name: "Idle Game Creator",
    description: "Read economy curves and propose balance tweaks per build.",
    status: "Planned",
  },
  {
    id: "custom-api",
    name: "Custom App / API",
    description: "REST contract for embedding any Mod-Mate companion in your product.",
    status: "Coming Soon",
  },
  {
    id: "react-widget",
    name: "React Widget",
    description: "Drop-in React component with a themeable chat surface.",
    status: "Planned",
  },
];
